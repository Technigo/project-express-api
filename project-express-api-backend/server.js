...
app.get("/books", (req, res) => {
    ...
    if (languageParam) {
        filteredBooks = filteredBooks.filter((book) => book.language_code === languageParam)
    }
    ...
    if (averageRatingParam) {
        ...
        filteredBooks = filteredBooks.filter((book) => Math.round(book.average_rating * 2) / 2 === roundedRating)
    }
