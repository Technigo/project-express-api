...
app.get("/winners", (req, res) => {
  ...
  if (artist) {
    contestants = contestants.filter(singleContestant => { return singleContestant.country.toLowerCase() === country.toLowerCase() });
  }
...
//     return c.country.toLowerCase() === req.params.countries.toLowerCase()
//   })
