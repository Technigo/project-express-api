...
app.get('/', (req, res) => {
  ...
  res.send("Try searches based on the routes: /books, /books/sort/rating, /booklists?page=2, /books/id/[a number], /author/[name of author], /titles/[name of title] or  query for any word in title or author: library?search=[type your search]")
